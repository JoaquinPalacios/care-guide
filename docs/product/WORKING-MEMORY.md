...
Last updated: 2026-09-08 (Phase 1F.13 early access composition, secondary fill, and footer separator light)
...
| Clinic preview | Right column is a static patient-home panel (Riverside Dental Demo, Tooth Extraction row, Call the practice) plus a caption. Brand directions remain the three identity cards above.                    |
