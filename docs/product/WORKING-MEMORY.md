...
Last updated: 2026-09-09 (Phase 1F.15 mobile composition, content density, and Brand Flexibility/Early Access spacing)
...
| **Current implementation**     | Staff auth + parked chairside sessions + Phase 1A–1C aftercare + **Phase 1E browser/performance acceptance** + **Phase 1F public marketing face** + **Phase 1F.1 Aftercare Guide branding, tenant presentation settings, and premium marketing/tenant UX** + **Phase 1F.2 marketing polish, recovery timeline, and local login DX** + **Phase 1F.3 visual simplification and document-led patient pages** + **Phase 1F.4 marketing Motion choreography and CSS-only patient card/timeline polish** + **Phase 1F.5 static marketing hero composition** + **Phase 1F.6 premium single-phone hero** + **Phase 1F.7 hero spacing, premium phone shell, and CSS-only CTA/nav/theme micro-interactions** + **Phase 1F.8 real iPhone frame overlay and bottom-center hero atmosphere** + **Phase 1F.9 mobile nav simplification, section spacing tokens, and richer static phone-screen content** + **Phase 1F.10 connected process rail, asymmetric feature bento, and restored theme popover** + **Phase 1F.11 story clarity, process consistency, light closing, and interaction rhythm** + **Phase 1F.12 design coherence, product assembly, clinic preview, and closing bookend** + **Phase 1F.13 early-access split, secondary centre-out fill, and footer separator light** + **Phase 1F.14 brand flexibility, theme radial fill, footer end-spacing, and public copy finalisation** + **Phase 1F.15 mobile storytelling: Product copy-first DOM, stacked How It Works cards, denser Why Clinics copy, and 64px mobile top padding on Brand Flexibility and Early Access**. Phase 1D was absorbed into 1C. Motion is approved for marketing presentation only. Patient clinical content remains motion-light and document-first. |
...
| Area           | Behaviour                                                                                                                                                                                                                                        |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Mobile nav     | Below `47.99rem`, same-page anchors (`How it works`, `Clinic preview`, `Early access`) are `display: none`. Header keeps Aftercare Guide, Staff sign in, and the compact theme control. Tablet/desktop keep the full nav. Footer anchors remain. |
...
| Closing         | Theme-aware. Light: soft periwinkle-neutral surface, dark ink, periwinkle CTA. Dark: deep ink, warm light text. Early access + footer share the closing chapter. No forced dark band in light mode.                   |
