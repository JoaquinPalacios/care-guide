...
Last updated: 2026-09-12 (Phase 2A.5 shell overflow / launch SEO policy)
...
Archive/unpublish of **published** guides, QR, invitations/team management, canonical library authoring, production Storage bucket for logos, Check-ins, RecoveryPlan, messaging, PMS integrations, billing.
...
| Overflow tests | `e2e/helpers/portal-shell.ts` fails if `scrollWidth > clientWidth + 1` on document, `.staffAppMain`, and `.staffAppScroller`. Covers Overview, Guides, editor, Practice, Operator All Clinics, operator clinic detail.                                                                                                                                                                                       |
