...
Last updated: 2026-09-08 (Phase 1F.10 premium process, bento features, and theme popover)
...
| Why clinics      | Asymmetric CSS Grid bento (6 / 2 / 2+2+2 / 6). Product-native micro-visuals only; no icon library. Cards are informational (no pointer, no translate hover).                                             |
| Motion readiness | `data-mk-process`, `data-mk-process-rail`, `data-mk-process-card`, `data-mk-bento`, `data-mk-bento-card`. No new `use client`.                                                                           |
