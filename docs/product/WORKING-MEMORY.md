...
| Mobile nav styling | Slightly larger sheet, route list separated from Sign in + Theme, current/selected inset brand bar. Same destinations. No hamburger morph.                                                                                                                                                      |
