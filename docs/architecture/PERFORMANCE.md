...
Measured 2026-09-11 against `cursor/portal-editor-practice-polish-2a3-a53d` production `next build` (Next.js 16.3.4 / Turbopack).

| Island       | Chunk              | raw    | gzip-9 | brotli-11 | vs Phase 2A.2                |
| ------------ | ------------------ | ------ | ------ | --------- | ---------------------------- |
