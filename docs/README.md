...
The aftercare **product** described in the PRD is not a complete commercial MVP. Phase 1A–1C plus 1E hardening are implemented (domain, hostname routing, styling isolation, public patient pages, browser acceptance). Phase 1D was absorbed into 1C. QR, operator admin, and analytics are later. The application also contains a parked chairside procedure-session product. See PRD §26 and [ADR 0009](adr/0009-existing-chairside-product-is-parked.md).
