  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        <div className={styles.marketingSoft}>
          ...
          <section
            className={`${styles.band} ${styles.chapterRule}`}
            ...
            <div className={styles.inner}>
              ...
              <ol className={styles.steps}>
                <li className={styles.step}>
                  ...
                  <h3>Select guides</h3>
                  <p>
                    The clinic enables the recovery guides that match the care
                    it provides.
                  </p>
                </li>
                <li className={styles.step}>
                ...
                <li className={styles.step}>
                  ...
                  <p>
                    The same instructions stay available after the appointment,
            ...
            <div className={styles.inner}>
              ...
              <ul className={styles.reasons}>
                ...
                <li>
                  ...
                  <p>
                    Call the practice from the same page as the instructions,
                    plus a distinct urgent-help block.
                  </p>
                </li>
                <li>
        ...
        <div className={styles.marketingShowcase}>
          ...
          >
            <div className={`${styles.inner} ${styles.previewGrid}`}>
              <div className={styles.previewCopy}>
                ...
                <p className={styles.copy}>
                  The Riverside Dental Demo tenant shows the patient experience:
                  a practice header, post-treatment instructions, and a
        ...
        <div className={styles.marketingClosing}>
          <section
            id="early-access"
          ...
          >
            <div className={styles.inner}>
              ...
              <p className={styles.fine}>
                {PRODUCT_NAME} is the current provisional commercial name for
                this aftercare product.
              </p>
            </div>
          </section>
        </div>
