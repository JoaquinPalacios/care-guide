...
Care Guide’s **product direction** is branded aftercare SaaS for healthcare practices. The **current codebase** is staff auth plus a **parked** chairside procedure-session product. Do not treat chairside sessions as the aftercare architecture. Aftercare must not depend on `ProcedureSession`. Do not claim aftercare MVP features are implemented until they exist.
