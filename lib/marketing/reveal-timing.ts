...
export const EDITORIAL_REVEAL_DURATION = 0.62;
export const EDITORIAL_REVEAL_STEP = 0.09;

/** Independent cards / process nodes. Cap keeps a desktop row from cascading. */
export const CARD_REVEAL_DURATION = 0.57;
export const CARD_REVEAL_STAGGER = 0.08;
export const CARD_REVEAL_STAGGER_MAX = 0.28;
