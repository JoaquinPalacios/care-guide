...
| Current code      | Staff auth + parked chairside sessions + Phase 1A–1G aftercare (domain, hostname routing, public patient pages, marketing homepage, interactive demo prototype on `demodental`, browser/performance acceptance). No persisted RecoveryPlan or patient PII. |
