...
| Current code      | Staff auth + parked chairside sessions + Phase 1A–1G.1 aftercare (domain, hostname routing, public patient pages, marketing homepage, Today/Timeline demo on `demodental`, browser/performance acceptance). No persisted RecoveryPlan, no Check-in, no patient PII. |
